        ...
        <div className='px-5 mt-11'>
            <div className='lg:flex md:flex py-5 mt-3'> 
                <div className='flex-1 px-4'>
                    ...
                    <h6 className='py-6'>I Have Been Designing And Developing Website For More Then 2 Years.i am a MERN strak web developar. It Will Be Responsive And Mobile-Friendly.If You Need To Build A Full Complete Website With More Functions And Unque Look For Your Service/Business/Protfolio Etc. Please Contact Me</h6>
